  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        injectRegister: 'auto',
        includeAssets: ['icon.svg', 'icons/favicon-16.png', 'icons/favicon-32.png'],
        manifest: {
          name: 'Whale — Digital Specialists',
          short_name: 'Whale',
          description: 'Find and book top digital specialists for your brand',
          start_url: '/',
          scope: '/',
          display: 'standalone',
        ...
        workbox: {
          ...
          navigateFallbackDenylist: [/^\/\.figma\//],
          runtimeCaching: [
            {
